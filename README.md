...
* <b>2022/07</b> PyMAF-X: Towards Well-aligned Full-body Model Regression from Monocular Images [[paper]](https://arxiv.org/abs/2207.06400) [[code]](https://github.com/HongwenZhang/PyMAF-X)
* <b>2022/08</b> CLIFF: Carrying Location Information in Full Frames into Human Pose and Shape Estimation [[paper]](https://arxiv.org/pdf/2208.00571v1.pdf) [[code]](https://github.com/huawei-noah/noah-research/tree/master/CLIFF)
...
## etc
* SMPL, SMPL-X, MANO, FLAME Annotator(Annotation) : [[code]](https://github.com/mkocabas/body-model-visualizer) 
